(function (window, document) {
    ...
    const exactTranslations = {
        ...
        'Customer Refund Due': 'Khoản Phải Hoàn Cho Khách',
        'Confirmed Purchases': 'Giá Trị Mua Đã Xác Nhận',
        'Vendor Debt': 'Công Nợ Nhà Cung Cấp',
        'Vendor Refund Due': 'Khoản NCC Phải Hoàn',
        ...
        'Refund or credit balance': 'Khoản Hoàn Tiền Hoặc Cấn Trừ',
        ...
        'Cash Flow by Category': 'Báo Cáo Thu Chi Theo Danh Mục',
        'Net Cash Flow': 'Chênh Lệch Dòng Tiền',
        ...
        'Opening Stock Date': 'Ngày Tồn Đầu Kỳ',
        'Effective date': 'Ngày hiệu lực',
        'Effective date: first day of the current month.': 'Ngày hiệu lực: ngày đầu tiên của tháng hiện tại.',
        ...
        'Excel export failed': 'Xuất Excel Thất Bại',
        'PDF generation failed': 'Tạo PDF Thất Bại',
        'Download PDF': 'Tải PDF',
        'The whole workbook is atomic: if one row is invalid, no rows are imported.': 'Toàn bộ file được nhập nguyên tử: nếu một dòng không hợp lệ thì không dòng nào được lưu.',
        'Please wait while the workbook is being validated and saved.': 'Vui lòng chờ trong khi hệ thống kiểm tra và lưu toàn bộ file.',
        'This report shows confirmed stock on hand by warehouse and product.': 'Báo cáo này hiển thị tồn kho đã xác nhận theo kho hàng và sản phẩm.',
        'Add the products, warehouses, quantities, taxes and serial details for this purchase order.': 'Thêm hàng hóa, kho, số lượng, thuế và thông tin serial cho đơn mua hàng này.',
        'Sales Type': 'Loại Xuất',
        ...
        'Manufacturer Serial': 'Serial Nhà Sản Xuất',
        'Warranty Lookup': 'Tra Cứu Bảo Hành',
        'SO Number': 'Số Đơn Bán',
        'Sold Date': 'Ngày Bán',
        'Issue / Sold Date': 'Ngày Xuất / Bán',
        ...
        'Remaining': 'Còn Lại',
        'Document': 'Chứng Từ',
        'Project Finance Report': 'Báo Cáo Tài Chính Công Trình',
        'Revenue': 'Doanh Thu',
        'Project Cost': 'Chi Phí Công Trình',
        'Profit': 'Lợi Nhuận',
        'Source Type': 'Loại Nguồn',
        'Source Id': 'Mã Nguồn',
        'Confirmed document value is shown after tax. Payments change paid and remaining debt only.': 'Giá trị chứng từ đã xác nhận được tính sau thuế. Thanh toán chỉ thay đổi số đã trả và công nợ còn lại.',
        'Confirmed sales revenue and allocated project costs are recognized independently from payment status.': 'Doanh thu bán hàng đã xác nhận và chi phí phân bổ được ghi nhận không phụ thuộc trạng thái thanh toán.',
    ...
    const termTranslations = {
        ...
        'confirmed purchases': 'giá trị mua đã xác nhận',
        'vendor debt': 'công nợ nhà cung cấp',
        'vendor refund due': 'khoản nhà cung cấp phải hoàn',
        'cash balance': 'số dư quỹ',
        'inventory quantity': 'số lượng tồn kho',
        'material exports': 'phiếu xuất vật tư',
        'recent sales orders': 'đơn bán hàng gần đây',
