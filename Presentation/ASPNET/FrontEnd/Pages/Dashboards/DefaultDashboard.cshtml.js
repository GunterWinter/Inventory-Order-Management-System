    ...
    setup() {
        ...
        const methods = {
            ...
            kpiCards: () => [
                ...
                { label: 'Customer Refund Due', value: methods.money(state.cards.customerCredit), note: 'Refund or credit balance', icon: 'fas fa-undo-alt', iconClass: 'bg-warning-subtle text-warning', href: '/CashTransactions/CustomerFinanceReport' },
                ...
                { label: 'Vendor Refund Due', value: methods.money(state.cards.vendorCredit), note: 'Refund or credit balance', icon: 'fas fa-reply', iconClass: 'bg-success-subtle text-success', href: '/VendorDebtReports/VendorDebtReportList' },
