    ...
    setup() {
        ...
        Vue.watch(
            ...
            (newVal, oldVal) => {
                ...
                if (typeof transferReceiveDatePicker !== 'undefined' && transferReceiveDatePicker.obj) transferReceiveDatePicker.obj.enabled = !isReadOnly;
                if (typeof numberText !== 'undefined' && numberText.obj) numberText.obj.enabled = !isReadOnly;
                if (typeof transferOutListLookup !== 'undefined' && transferOutListLookup.obj) transferOutListLookup.obj.enabled = !isReadOnly;
