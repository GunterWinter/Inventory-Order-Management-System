...
- `npm.cmd run test:browser:sales-items`: tạo Product có tồn đầu kỳ hoàn toàn qua UI, xác nhận giá/tồn sau lưu, chọn Product trong SO/PO và thấy giá ngay trước Enter, sau đó chọn thuế, lưu và reload item đúng giá. Gate này cũng chạy Quick Add Product/Group/Warehouse, tìm lại bản ghi mới trên chính dropdown đang edit và kiểm tra placeholder EN/VI.
